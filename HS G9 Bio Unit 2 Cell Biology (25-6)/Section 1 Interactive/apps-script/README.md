...
The master Sheet is already linked in `Code.gs`:
[G9 Bio U2 S1 — Content](https://docs.google.com/spreadsheets/d/1zPY_mBm1BwdP4TRJQq2O5L1EDucLAlI-69LliQW8LPo/edit)

## Step 1 — Create the Apps Script project

1. Go to **script.google.com**, click **New project**.
2. Rename the project to: `G9 Bio U2 S1 Web App`.
3. Delete the default `Code.gs` content. Paste the contents of this folder's `Code.gs`.
...
8. Copy the **Web app URL**. Paste it into `../sheet-link.md` so we don't lose it.
